...
$string['actionfilter_help'] = 'Enter part of an action name and click "Show report" (case-insensitive substring).';
...
$string['modulefilter_help'] = 'Enter part of a course module name and click "Show report" (case-insensitive substring).';
