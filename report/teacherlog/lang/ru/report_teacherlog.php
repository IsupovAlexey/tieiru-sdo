...
$string['actionfilter_help'] = 'Введите часть названия действия и нажмите «Показать отчёт» (поиск по подстроке, без учёта регистра).';
...
$string['modulefilter_help'] = 'Введите часть названия элемента курса и нажмите «Показать отчёт» (поиск по подстроке, без учёта регистра).';
